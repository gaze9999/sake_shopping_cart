...
<main class="main_frame">
  <div class="container-fluid d-flex flex-column center_all page_main">
    <div class="row w-100">
      <section class="col-sm-12 col-md-12 col-xl-12 w-100 d-flex center_all main_logoSec">
        <header class="h-100" data-aos="zoom-out" data-aos-duration="1000">
          <figure class="d-flex center_all">
            <img class="img-fluid d-block main_logo" src="./img/icons/main_icon.svg" alt="本格の酒">
            <h1>本 格 の 酒</h1>
          </figure>
        </header>
      </section>
      ...
      <section class="col-sm-12 col-md-12 col-xl-12 w-100 d-flex flex-column center_all main_news">
        <figure>
          <img src="./img/icons/main_icon.svg" alt="">
          <h2>最新消息</h2>
        </figure>
