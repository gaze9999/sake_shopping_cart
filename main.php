    ...
    <div class="row w-100">
      <section class="col-sm-12 col-md-12 col-xl-12 w-100 main_sakura">
        ...
        <section class="col-sm-12 col-md-12 col-xl-12 w-100 d-flex center_all main_article_center">
          <article class="d-flex w-100 center_all main_article_about" data-aos="zoom-out" data-aos-duration="1000">自1900年成立（明治33年）以來，<br/>高橋清酒釀酒廠一直致力<br/>於在位於熊本縣最南端的人吉和久馬地區<br/>製作正宗的米燒酒。<br/>生產的不僅是稻米燒酒，還包括有400多年曆史的熊馬燒酒。<br/>熊麻燒酒與長崎的讚岐燒酒，鹿兒島的薩摩燒酒和沖繩的<br/>琉球琉森燒酒相比，這是只有四個正宗燒酒的品牌。</article>
        </section>
      ...
      <section class="col-sm-12 col-md-12 col-xl-12 w-100 d-flex flex-column center_all">
        <figure class="d-flex flex-column center_all">
          <img class="img-fluid main_logo" src="./img/icons/main_icon.svg" alt="">
