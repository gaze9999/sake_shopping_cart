...
<main class="main_frame">
  <div class="container-fluid d-flex flex-column center_all page_main">
    <div class="row w-100">
      <section class="col-12 w-100 main_sakura">
        ...
        <section class="col-12 w-100 d-flex center_all main_article_center">
      ...
      <section class="col-12 w-100 d-flex flex-column main_news">
      ...
      <section class="col-12 w-100 d-flex flex-column center_all main_knowledge">
        <?php require_once('./tpl/main/tpl-main-knowledge.php'); ?>
      </section>

      <section class="col-12 w-100 d-flex flex-column main_recommand">
      ...
      <section class="col-12 w-100 d-flex h-100 flex-column main_map">
        <figure class="d-flex flex-column center_all index_title">
          <img class="img-fluid main_logo" src="./img/icons/sake_icon.svg" alt="">
